package com.chinalife.servlet.listener;
 ...
 */
public class MFServletContextListener implements ServletContextListener {
    private Logger logger = Logger.getLogger(MFServletContextListener.class);
